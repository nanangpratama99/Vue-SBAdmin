<template>
  <div class="align-items-start">
    <div class="d-flex">
      ...
      <div style="width: 100%">
        <Topbar></Topbar>
        <Dashboard v-show="success2"></Dashboard>
        <ViewCompVue v-show="success"></ViewCompVue>
        <AddCompVue
          v-show="success1"
          class="border border-primary p-4 m-4 rounded"
        ></AddCompVue>
      </div>
    </div>
    <Footer class="border border-primary"></Footer>
  </div>
</template>
...
import ViewCompVue from "@/components/ViewComp.vue";
import AddCompVue from "@/components/AddComp.vue";
import Dashboard from "@/components/DashboardC.vue";
